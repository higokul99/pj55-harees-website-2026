        ...
        if ($check->num_rows > 0) {
            ...
            if ($result && $result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    echo "<tr>";
                    echo "<td>" . $serial_no . "</td>"; // Serial No in increasing order
            ...
            echo "<tr><td colspan='4'>No table found for this selection.</td></tr>";
        }
    } else {
        echo "<tr><td colspan='4'>Invalid material selected.</td></tr>";
    }
    exit;
}
?>
...
<table class="table text-white">
    ...
    <tbody id="productTable">
        <tr><td colspan="4">Select a material and category to load products.</td></tr>
    </tbody>
</table>
 </div>
                    </div>
