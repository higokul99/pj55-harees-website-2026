...
$sql = "SELECT * FROM metal_rates WHERE type = 'RoseGoldSilver'";
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-secondary text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h1 class="mb-4" style="color: #f5d02a;">Rose Gold Silver Calculator</h1>
                    ...
                    <form method="POST">
                                ...
                                <div class="row mb-3">
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Rose Gold Silver Rate :</label>
                                    <div class="col-sm-10">
