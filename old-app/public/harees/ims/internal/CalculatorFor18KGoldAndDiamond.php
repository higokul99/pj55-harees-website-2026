                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h1 class="mb-4" style="color: #f5d02a;">18K + Diamond Calculator</h1>
<?php
if (isset($_POST['Calculate'])) {
    $goldtype = $_POST['goldtype'];
    $Gram = $_POST['gram'];
    $MakingCharge = $_POST['makingCharge'];
    $Diamond_cent = $_POST['dcent'];
    $DiamondRate = $_POST['drate'];
    $GST = $_POST['gst'];
...
$DiamondCost = $Diamond_cent * $DiamondRate;
$GRMC_DC = $GoldCost_MakingCharges + $DiamondCost;
$GST_Only = $GRMC_DC * $GST/100;


$FinalRate = $GRMC_DC + $GST_Only ;

echo '<div class="mb-3">';
echo '<span>Customer Rate : </span>';
echo '<h1 class="mb-4" style="color: #f5d02a;">' . ' '. $FinalRate . '</h1>';
echo '<h6 class="mb-4" style="color:rgb(217, 220, 168);">MC - '. $Making_Charges . ' | DCost - '.$DiamondCost.' | GST - '.$GST_Only.'</h6>';
echo '<span>GWeight(in gm) : '.$Gram.'gm | MC : '.$MakingCharge.'% |Dia CT : '.$Diamond_cent.' | | GST : '.$GST.'%</span>';
...
?>
                            <form method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Diamond Cent :</label>
                                    <input type="decimal" name="dcent" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Diamond Rate :</label>
                                    <input type="decimal" name="drate" class="form-control" value="1100">
                                </div>
                                <div class="mb-3">
