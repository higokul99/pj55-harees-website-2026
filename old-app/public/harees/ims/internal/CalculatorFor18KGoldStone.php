                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h1 class="mb-4" style="color: #f5d02a;">18K + Stone Calculator</h1>
<?php
...
//MakingCharge is percent variable name and below is different
$Making_Charges = $Gold_Cost_Only * ($MakingCharge /100);
$GoldCost_MakingCharges = $Gold_Cost_Only + $Making_Charges;
$SCost = $Swt * $SRate;
$GRMC_SC = $GoldCost_MakingCharges + $SCost;
$GST_Only = $GRMC_SC * $GST/100;


$FinalRate = $GRMC_SC + $GST_Only ;

echo '<div class="mb-3">';
echo '<span>Customer Rate : </span>';
echo '<h1 class="mb-4" style="color: #f5d02a;">' . ' '. $FinalRate . '</h1>';
echo '<h6 class="mb-4" style="color:rgb(217, 220, 168);">MC - '. $Making_Charges . ' | SCost - '.$SCost.' | GST - '.$GST_Only.'</h6>';
echo '<span>GWeight(in gm) : '.$Gram.'gm | MC : '.$MakingCharge.'% | S Wt : '.$Swt.' | | GST : '.$GST.'%</span>';
echo '<span>GC: '.$Gold_Cost_Only.' | MCC : '.$GoldCost_MakingCharges.' |ST : '.$SCost.' | GRMC_SC : '.$GRMC_SC.' | GST : '.$GST.'%</span>'; 
echo '</div>';
...
?>
                            <form method="POST">
                                ...
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Stone Wt :</label>
                                    <input type="decimal" name="swt" class="form-control">
                                </div>
                                <div class="mb-3">
                                    <label for="exampleInputEmail1" class="form-label">Stone Rate :</label>
                                    <input type="decimal" name="srate" class="form-control" value="1100">
                                </div>
                                <div class="mb-3">
